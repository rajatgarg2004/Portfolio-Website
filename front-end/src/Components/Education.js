        ...
        <div className="flex flex-col justify-center items-center p-10" id="experience">
            ...
            <ul className="w-[100%] sm:w-[80%] md:w-[80%] lg:w-[80%] text-left">
                <ul className='list-none m-6'>
                    <li className="font-bold text-sm sm:text-xl md:text-2xl lg:text-3xl xl:text-4xl">
                        B.Tech in Electrical Engineering
                    </li>
                    <li className="text-[0.6rem] sm:text-xs md:text-sm lg:text-xl font-bold flex flex-row justify-between items-center">
